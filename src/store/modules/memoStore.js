...
const actions = {
    ...
    axios.get('http://qnftkwh85.dothome.co.kr/page-miniblog/read.php')
    .then(response => {
    ...
    axios.get(`http://qnftkwh85.dothome.co.kr/page-miniblog/write.php?user=${addData.user}&title=${addData.title}&date=${addData.date}&icon=${ addData.icon }`)  
    .then(response => {
    ...
    axios.get(`http://qnftkwh85.dothome.co.kr/page-miniblog/delete.php?id=${obj.id}`)
    .then(response => {
    ...
    axios.get(`http://qnftkwh85.dothome.co.kr/page-miniblog/update.php?id=${obj.item.id}&complete=${complete}`)
    .then(response => {
    ...
    // 정상적으로 처리되었다면
    // 아래를 실행한다.
    axios.get("http://qnftkwh85.dothome.co.kr/page-miniblog/delete.php?id=all")
    .then(response => {
...
const mutations = {
  ...
  // 아이템 추가 {item, index}
    ...
    // 가지고 와서 목록 1개를 추가한다.
    axios.get(`http://qnftkwh85.dothome.co.kr/page-miniblog/get.php?user=${payload.user}`)
    .then(response => {
